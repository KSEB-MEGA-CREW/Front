        ...
        <div className="p-6 space-y-6">
                ...
                {isEditMode ? (
                  <input
                    ...
                    className={`
                      ...
                      ${
                        theme === "high-contrast"
                          ? "bg-black border-yellow-400 border-2 text-yellow-400 focus:border-yellow-400 focus:ring-yellow-400/30"
                          : isDarkMode
                          ? "bg-gray-700 border-gray-600 text-white focus:border-blue-500"
                          : "bg-white border-gray-300 text-gray-900 focus:border-blue-500"
                      }
                      focus:outline-none focus:ring-2 ${theme === "high-contrast" ? "focus:ring-yellow-400/30" : "focus:ring-blue-500/20"}
                    `}
              ...
              <div className="flex-1">
                ...
                {isEditMode ? (
                  <select
                    ...
                    `}
                  >
                    <option value="" className={theme === "high-contrast" ? "bg-black text-yellow-400" : ""}>
                      청각상태를 선택하세요
                    </option>
                    <option value="NORMAL" className={theme === "high-contrast" ? "bg-black text-yellow-400" : ""}>
                      청인
                    </option>
                    <option value="DEAF" className={theme === "high-contrast" ? "bg-black text-yellow-400" : ""}>
                      농인
                    </option>
                  </select>
                ) : (
          ...
          {error && (
            <div
              ...
              ${
                theme === "high-contrast"
                  ? "bg-black border-yellow-400 border-2 text-yellow-400"
                  : isDarkMode
            ...
            >
              <button
                ...
                className={`
                  ...
                  ${
                    theme === "high-contrast"
                      ? isLoading
                        ? "bg-gray-600 cursor-not-allowed text-yellow-400 border-2 border-gray-600"
              ...
              <button
                ...
                className={`
                  ...
                  ${
                    theme === "high-contrast"
                      ? "border-yellow-400 border-2 hover:bg-yellow-400 hover:text-black text-yellow-400 bg-black"
                      : isDarkMode
