...
function MainPage() {
  ...
  const [reduceMotion, setReduceMotion] = useState(true); // Change this line to true
  const [translationDemo, setTranslationDemo] = useState(false); // 방문자 수 (랜덤 임시값, 실제 서비스 연동 시 API 사용)
...
              )`,
      ...
      >
        ...
        >
                    수어 통역이{" "}
          <span className="text-white">더 가까워집니다</span>       {" "}
        </h1>
                      {" "}
        {/*
        <p
