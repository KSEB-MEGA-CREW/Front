...
const VideoPage = () => {
 ...
 }, [startFrameExtraction, stopFrameExtraction, isProcessing, isConnected, connectionState]);
    ...
    const initializeCamera = async () => {
        ...
        try {
            ...
            try {
                ...
                console.log("권한 확인 불가 (일부 브라우저에서 정상):", permErr.message);
            }
...
useEffect(() => {
 ...
 const toggleRecording = useCallback(async () => {
   ...
   console.log("카메라 상태:", { isCameraReady, videoRef: !!videoRef.current });
 ...
 }, [isProcessing, isCameraReady, startFrameExtraction, stopFrameExtraction, isConnected, connectionState]);
