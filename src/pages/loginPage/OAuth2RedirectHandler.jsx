  ...
  useEffect(() => {
    const handleOAuth2Redirect = async () => {
      try {
        ...
        if (token) { // OAuth2AuthenticationSuccessHandler 연결
    ...
    const getErrorMessage = (error) => {
      switch (error) {
        case 'no_email': return '이메일 정보를 가져올 수 없습니다.';
        case 'auth_failed': return '소셜 로그인에 실패했습니다.';
        case 'server_error': return '서버 오류가 발생했습니다.';
