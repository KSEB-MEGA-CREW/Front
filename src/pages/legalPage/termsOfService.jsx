        ...
        >
          <div className="space-y-8">
            ...
            <section>
              ...
              >
                <li>
                  <strong>1. "서비스"</strong>란 회사가 제공하는 수어 번역, 수어
                  학습, 퀴즈 시스템 등 모든 서비스를 의미합니다.
                </li>
                <li>
            ...
            <section>
              ...
              >
                <p>
                  <strong>1.</strong> 이 약관은 서비스를 이용하고자 하는 모든
                  이용자에 대하여 그 효력을 발생합니다.
                </p>
                <p>
                  <strong>2.</strong> 회사는 필요한 경우 관련 법령을 위배하지
                  않는 범위에서 이 약관을 변경할 수 있습니다.
                </p>
                <p>
                  <strong>3.</strong> 약관이 변경되는 경우 회사는 변경사항을
                  시행일자 7일 전부터 서비스 내 공지사항을 통해 공지합니다.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              >
                ...
                <p>
                  <strong>2.</strong> 회사는 제1항과 같이 회원으로 가입할 것을
            ...
            <section>
              ...
              >
                <li>
                  • 이용자는 회원가입 신청 또는 회원정보 변경 시 실명으로 모든
                  사항을 사실에 근거하여 작성해야 합니다.
                </li>
                ...
                <li>
                  • 이용자는 회사의 서비스 제공 목적에 어긋나는 용도로 서비스를
                  이용해서는 안 됩니다.
                </li>
                <li>
                  • 이용자는 관련 법령, 이 약관의 규정, 이용안내 및 서비스상에
                  공지한 주의사항, 회사가 통지하는 사항 등을 준수해야 합니다.
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              >
                <p>
                  회사는 다음 각 호의 경우에는 서비스 이용을 제한할 수 있습니다:
                </p>
                <ul className="space-y-2 ml-4">
                  <li>
                    • 시스템 정기점검, 서버 증설 및 교체, 네트워크의 불안정 등의
                    시스템 운영상 필요한 경우
                  </li>
                  <li>
            ...
            <section>
              ...
              >
                ...
                <p>
                  <strong>2.</strong> 회사는 이용자의 귀책사유로 인한 서비스
                  이용의 장애에 대하여는 책임을 지지 않습니다.
                </p>
                <p>
                  <strong>3.</strong> 회사는 이용자가 서비스를 이용하여 기대하는
                  수익을 얻지 못하거나 상실한 것에 대하여는 책임을 지지
                  않습니다.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              >
                ...
                >
                  <p>
                    <strong>회사명:</strong> 수담
                  </p>
                  <p>
                    <strong>고객지원:</strong> dissolve1882@naver.com
                  </p>
                  <p>
                    <strong>전화:</strong> 010-3738-1882
                  </p>
                  <p>
                    <strong>운영시간:</strong> 평일 09:00~18:00 (토·일·공휴일
                    제외)
                  </p>
                </div>
              </div>
