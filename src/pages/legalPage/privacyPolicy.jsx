          ...
          <div className="space-y-8">
            ...
            `}>
              ...
              <p className={`text-sm ${isDarkMode ? 'text-blue-200' : 'text-blue-600'}`}>
                수담(수어 번역 서비스)은 사용자의 개인정보 보호를 최우선으로 합니다.
              </p>
            </div>
            ...
            <section>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <ul className={`space-y-2 ml-4 ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
            ...
            <section>
              ...
              <ul className={`space-y-2 ml-4 mt-4 ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
            ...
            <section>
              ...
              `}>
                <div className={`space-y-2 ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                  <p><strong>개인정보 보호책임자:</strong> 수담 운영팀</p>
                  <p><strong>이메일:</strong> privacy@sudam.com</p>
                  <p><strong>전화:</strong> 02-1234-5678</p>
                  <p><strong>처리시간:</strong> 평일 09:00~18:00 (토·일·공휴일 제외)</p>
                </div>
              </div>
            </section>
          </div>
